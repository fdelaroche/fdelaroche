...
[Source](https://www.howtogeek.com/181/keyboard-shortcuts-for-bash-command-shell-for-ubuntu-debian-suse-redhat-linux-etc/)

## Meta key on Mac

The Meta key refers to the Option key on Mac, and Alt on Windows keyboard.
...
- Meta+B: Go left (back) one word.
- Ctrl+B: Go left (back) one character.
- Meta+F: Go right (forward) one word.
...
- Meta+D: Delete all characters after the cursor on the current line.
...
- Meta+L: Uncapitalize every character from the cursor to the end of the current word, converting the characters to lower case.
...
- Meta+R: Revert any changes to a command you've pulled from your history if you've edited it.
